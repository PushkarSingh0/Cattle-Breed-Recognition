...
GATEKEEPER_MODEL_PATH = 'models/gatekeeper_model.pt'
...
BREED_MODEL_PATH = 'models/best_breed_classifier_b3.pt' 
CLASSES_PATH = 'models/breed_class_names.json'
...
def predict():
    ...
    try:
        ...
        with torch.no_grad():
            ...
            # --- MODIFICATION: Get top 3 predictions ---
            ...
            for i in range(3):
                ...
                breed_index = top3_indices[0][i].item()
                breed_name = breed_class_names[breed_index]
        ...
        return jsonify({
            ...
            "predictions": predictions_list  # --- MODIFICATION: Send the list
        })
